...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        <!--begin::Menu Nav-->
        <ul class="menu-nav">
            <li class="menu-item {{ $title == 'Dashboard' ? 'menu-item-active' : null }}" aria-haspopup="true">
            ...
            <li class="menu-item {{ $title == 'Kriteria' ? 'menu-item-active' : null }}" aria-haspopup="true">
            ...
            <li class="menu-item {{ $title == 'Data Siswa' ? 'menu-item-active' : null }}" aria-haspopup="true">
            ...
            <li class="menu-item {{ $title == 'Perhitungan' ? 'menu-item-active' : null }}" aria-haspopup="true">
